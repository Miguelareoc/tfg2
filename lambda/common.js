...
const i18n = require('i18next'); // frases 
const sprintf = require('i18next-sprintf-postprocessor'); // frases con %s
...
const IntentReflectorHandler = {
    ...
    handle(handlerInput) {
        ...
        const speakOutput = `Estas probando ${intentName}`;

        return handlerInput.responseBuilder
            .speak(speakOutput)
            .reprompt("No entendí el comando, pruebelo otra vez.")
            .getResponse();
    }
};
...
const ErrorHandler = {
    ...
    handle(handlerInput, error) {
        ...
        const speakOutput = `Lo siento. Ha ocurrido un error. Por favor, pruébelo otra vez.`;
...
const LocalisationRequestInterceptor = {
    process(handlerInput) {
        ...
        localizationClient.localize = function localize() {
            ...
            const value = i18n.t(args[0], {   // cambiar los %s por parametros 
                returnObjects: true,
                postProcess: 'sprintf',     
                sprintf: values,
            });
